...
def get_pairs(idx):
    title = normalize_string(data[idx]["title"])
    body = normalize_string(data[idx]["body"])
    return [title, body]
...
def read_jokes():
    ...
    for i in range(len(data)):
        ...
        bodies.append(data[i]["body"])
    input_lang = Lang(titles)
    output_lang = Lang(bodies)
    return input_lang, output_lang, pairs

def prepare_jokes():
    input_lang, output_lang, pairs = read_jokes()
...
input_lang, output_lang, pairs = prepare_jokes()
